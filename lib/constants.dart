...
const kConfirmedColor = Colors.teal;
const kRecoveredColor = Colors.green;
const kDeathsColor = Colors.brown;
const kNewCasesColor = Colors.deepOrange;
const kNewDeathsColor = Colors.black38;
